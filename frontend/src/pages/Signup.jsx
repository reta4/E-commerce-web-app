...
import use_user_store from "../stores/use_user_store.js";
const Signup = () => {
  ...
  const { signup, loading } = use_user_store();
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px lg::px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-gray-800  py-8 shadow sm:rounded-lg sm:px-10 ">
          <form onSubmit={handle_submit} className="space-x-6">
            <div>
              <label
                htmlFor="name"
